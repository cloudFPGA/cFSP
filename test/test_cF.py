...
#first_cluster = clusters_data[0]
#print(first_cluster)
#cluster_data = cFPy.mngmt.get_cluster_data(my_user, first_cluster)
#print(cluster_data)
...
#instance_data = cFPy.mngmt.get_instance_data(instance_id)
#print(instance_data)
#print("############# End testing:   get_instance_data ###############\n\n")

#print("############# Start testing: restart_instance_data ###############\n")
#if type(my_cluster) is cFPy.mngmt.cFcluster:
#cFPy.mngmt.restart_instance_app(instance_id)
